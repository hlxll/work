<template>
	<div class="register">
      ...
      <tr>登录密码<input type="text" name="password" placeholder="请输入登录密码" v-model="password"/></tr>
      <tr><td>验证码 <input type="text" name="verify" placeholder="请输入验证码" v-model="verify_num"/></td>
	  <td><cpn></cpn></td>
